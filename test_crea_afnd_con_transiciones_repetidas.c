...
int main(){
  ...
  addTransition(q,s, deterministic, &delta, create_str_from_chain("a"), create_str_from_chain("qf"), create_str_from_chain("q1"));
  addTransition(q,s, deterministic, &delta, create_str_from_chain("a"), create_str_from_chain("qf"), create_str_from_chain("q0"));
