...
int main(){
  ...
  printf("Pruebas: Creación de intersecciones\n");
  printf("1) Intersección de un set vacío con un set con cadenas\n");
  ...
  free(set3);
//////////////////////////////////////////////////////////////////
  printf("2) Intersección de dos sets con cadenas\n");
  ...
  free(set3);
//////////////////////////////////////////////////////////////////
  printf("3) Intersección de un set con cadenas y otro con una lista\n");
  set1 = create_set();
  ...
  free(list1);
//////////////////////////////////////////////////////////////////
  printf("4) Intersección de un set con un set dentro y otro con una lista dentro\n");
  set1 = create_set();
  set4 = create_set();
  ...
  free(list1);
//////////////////////////////////////////////////////////////////
  printf("5) Intersección de dos sets que contienen listas\n");
  ...
  free(list2);
//////////////////////////////////////////////////////////////////
  printf("6) Intersección de dos sets que contienen sets\n");
